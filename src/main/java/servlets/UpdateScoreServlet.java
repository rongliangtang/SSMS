    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (conn != null) {
                ...
                String condition = "update score SET classname = ?,score = ? WHERE classname = ? and username = ?;";
                sql = conn.prepareStatement(condition);
                sql.setString(1, newclassname);
                sql.setString(2, newscore);
                sql.setString(3, classname);
